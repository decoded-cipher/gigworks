          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-8">
              {isScrolled ? (
                ...
                <div className="flex items-center space-x-8">
                  <SearchSection />
                  <button className="border border-green-500 hover:text-green-500 text-xl font-bold bg-tertiary text-white px-4 py-2 rounded-md transition duration-300">
                    Login / Sign Up
                  </button>
                </div>
              )}
  ...
  <div className="hidden lg:block bg-white rounded-md shadow-lg w-[350px] h-[100px] absolute -top-3/4 right-[20%] translate-y-full mt-96">
    <div className="flex flex-row justify-start h-full">
      ...
      <h2 className="text-2xl font-bold mt-2 ml-3">
        <span className="text-4xl  text-black">1000+</span><br /><span className="font-light text-gray-300">Happy Customers</span>
      </h2>
    </div>
  </div>
</div>
      ...
      {/* Contact Us */}
      <section className="container bg-cbg mx-auto px-3 md:px-[42px] py-16 flex flex-col items-center">
        <h2 className="text-3xl font-bold mb-8 ">
