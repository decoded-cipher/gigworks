            ...
            <div className="w-full max-w-sm p-4 border rounded-lg shadow sm:p-8 bg-green-900 border-gray-700">
              ...
              <ul role="list" className="space-y-5 my-7">
                ...
                <li className="flex">
                  ...
                  <span className="text-base font-normal leading-tight text-gray-400 ms-3">
                    Showcase your business with a professional portfolio
                ...
                <li className="flex">
                  ...
                  <span className="text-base font-normal leading-tight text-gray-400 ms-3">
                    Let your customers find you instantly through our
                    easy-to-use WhatsApp-based search tool.
                  </span>
                </li>
              </ul>
              <button
                ...
                className="text-white focus:ring-4 focus:outline-none bg-green-700 hover:bg-green-600 focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center"
              >
                Start now
              </button>
            </div>
