  ...
  return (
    <div>
      ...
      <div className='mx-auto px-44 pt-5 pb-16 '>
        ...
        <p className='text-xl font-bold py-4'>3. How We Share Your Information</p>
        <p className='text-xl'>We may share your information in the following circumstances:</p>
        <ul className='px-4 list-disc'>
            <li className='py-2 text-xl'><span className='font-bold'>With Users: </span> Business information provided by you will be visible to users of our directory when they search for businesses within your category.
            </li>
            <li className='py-2 text-xl'><span className='font-bold'>Service Providers:</span> We may share your information with third-party service providers who assist us in operating our website and delivering our services (e.g., hosting providers, payment processors).
            </li>
            <li className='py-2 text-xl'><span className='font-bold'>Legal Compliance:</span> We may disclose your information if required by law or in response to legal processes (e.g., a court order or subpoena).
            </li>
            <li className='py-2 text-xl'><span className='font-bold'>Business Transfers:</span> In the event of a merger, acquisition, or sale of all or a portion of our assets, your information may be transferred to the acquiring entity.
            </li>
        </ul>

        <p className='text-xl font-bold py-4'>4. Data Security</p>
        <p className='text-xl'>We implement industry-standard security measures to protect your information from unauthorized access, disclosure, or alteration. However, no method of transmission over the internet or electronic storage is 100% secure, and we cannot guarantee absolute security.</p>

        <p className='text-xl font-bold py-4'>6. Your Choices</p>
        <ul className='px-4 list-disc'>
            <li className='py-2 text-xl'><span className='font-bold'>Access and Update: </span> You can access and update your business information at any time by contacting us or using the relevant features on our website.
            </li>
            <li className='py-2 text-xl'><span className='font-bold'>Opt-Out:</span> If you no longer wish to receive marketing communications from us, you can opt out by following the unsubscribe instructions in those communications.
            </li>
            <li className='py-2 text-xl'><span className='font-bold'>Data Deletion:</span> You can request the deletion of your personal information by contacting us. We will comply with your request, subject to our legal obligations.
            </li>
        </ul>

        
        <p className='text-xl font-bold py-4'>6. Third-Party Links</p>
        <p className='text-xl'>Our website may contain links to third-party websites. We are not responsible for the privacy practices or content of these external sites. We encourage you to review the privacy policies of any third-party sites you visit.</p>
        
        <p className='text-xl font-bold py-4'>7. Changes to This Policy</p>
        <p className='text-xl'>We may update this Privacy Policy from time to time. Any changes will be posted on this page, and we will notify you of any significant changes by email or through our services.</p>
        
        <p className='text-xl font-bold py-4'>8. Contact Us</p>
        <p className='text-xl'>If you have any questions or concerns about this Privacy Policy or our privacy practices, please contact us at <span className='font-bold'>[Your Contact Information]</span>.</p>
