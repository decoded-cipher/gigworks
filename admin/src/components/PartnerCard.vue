<template>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 mb-4">
        <div class="flex items-center justify-between">
            ...
            <div class="w-1/4 flex items-center gap-4">
                <div class="text-gray-400">
                    <template v-if="partner.partner.avatar">
                        <img class="w-20 h-20 rounded-full border border-gray-600"
                ...
                <div class="flex flex-col">
                    <h1 class="font-bold text-white">{{ partner.user.name }}</h1>
                    <p class="text-sm text-gray-400">{{ partner.partner.referral_code }}</p>
                </div>
            </div>

            <!-- Analytics summary -->
            <div class="w-1/4 flex flex-col text-center">
                <p class="text-sm text-gray-400">Total Business</p>
                <h2 class="text-lg font-bold text-white">{{ getTotalCount() }}</h2>
            </div>
            ...
            <div class="w-1/4 flex flex-col text-center gap-1">
                ...
                <div class="flex gap-2 justify-center">
                    ...
                    <button class="text-white hover:text-blue-500 transition-colors duration-300 ease-in-out"
            ...
            <div class="w-1/4 flex flex-col items-end">
                ...
                <button @click="showDetails" :class="[
                    'mt-1 px-4 py-2 text-white rounded transition-colors',
        ...
        <!-- Details Modal -->
        <div v-if="detailsVisible" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"
            @click.self="closeDetails">
            <div class="bg-white dark:bg-gray-800 rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-xl font-bold text-gray-900 dark:text-white">Partner Details</h2>
