<template>
    ...
    <div
        class="w-full shadow-lg rounded-lg overflow-hidden px-4 py-3 flex gap-4 justify-between items-center bg-white dark:bg-gray-800">

        <div class="w-1/4 flex items-center gap-4">
            <div class="text-gray-400">
                <template v-if="business.avatar">
                    <img class="w-20 h-20 rounded-full border border-gray-600" alt="User Avatar"
                        :src="`${cdn_url}/${business.avatar}`" />
                </template>
                <template v-else>
        ...
        <div class="w-1/4 flex flex-col text-center gap-1">
            ...
            <div class="flex gap-2 justify-center">
                <button class="text-white hover:text-green-500 transition-colors duration-300 ease-in-out"
                ...
                <button class="text-white hover:text-red-500 transition-colors duration-300 ease-in-out"
